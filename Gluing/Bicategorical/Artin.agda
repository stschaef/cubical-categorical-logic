...
open import Cubical.Categories.Presheaf.StrictHom.Base using
  (PshHomStrict ; pshhom ; makePshHomStrictPath ; isSetPshHomStrict
  ; PRESHEAF)
...
module _ {ℓB ℓB' : Level} (B : Category ℓB ℓB') (ℓP : Level) where
  private
