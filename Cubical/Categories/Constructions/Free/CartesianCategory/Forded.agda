  ...
  module _ (CC : CartesianCategory ℓC ℓC') where
    ...
    module _
      ...
      private
        ...
        CCCᴰF,G-IsoC = IsoCommaCartesianᴰ FreeCartesianCategory
          (F , F-bp) (G , G-bp) F-1 G-1

      module _ (ı : ElimInterpᴰ CCCᴰF,G-IsoC) where
        FreeCartesianCatFunctor≅ : NatIso F G
        FreeCartesianCatFunctor≅ =
          sectionToNatIso FreeCartesianCategory (F , F-bp) (G , G-bp) F-1 G-1
            (elimCartesian CCCᴰF,G-IsoC ı .CartesianSection.section)
